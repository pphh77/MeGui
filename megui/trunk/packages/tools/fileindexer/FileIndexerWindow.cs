    ...
    public partial class FileIndexerWindow : Form
    {
        ...
        private void CheckDGIIndexer()
        {
            ...
            if (MainForm.Instance.Settings.IsDGIIndexerAvailable() || MainForm.Instance.Settings.IsDGMIndexerAvailable())
            {
                ...
                filter += "|All supported files|*.264;*.avc;*.avi;*.flv;*.h264;*.ifo;*.m1v;*.m2t*;*.m2ts;*.m2v;*.mkv;*.webm;*.mp4;*.mpeg;*.mpg;*.mpls;*.mpv;*.mts;*.ogm;*.pva;*.tp;*.trp;*.ts;*.vc1;*.vob;*.vro;*.wmv";
                filter += "|All files|*.*";
                input.Filter = filter;
                if (MainForm.Instance.Settings.IsDGIIndexerAvailable() && MainForm.Instance.Settings.IsDGMIndexerAvailable())
                    input.FilterIndex = 6;
            ...
            {
                filter += "|All supported files|*.264;*.avc;*.avi;*.flv;*.h264;*.ifo;*.m1v;*.m2t*;*.m2ts;*.m2v;*.mkv;*.webm;*.mp4;*.mpeg;*.mpg;*.mpls;*.mpv;*.mts;*.ogm;*.pva;*.tp;*.trp;*.ts;*.vob;*.vro;*.wmv";
                filter += "|All files|*.*";
                input.Filter = filter;
                input.FilterIndex = 4;
